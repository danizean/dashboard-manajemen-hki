...
const DetailItem = memo(({ label, value, children, className }: DetailItemProps) => {
...
export const ViewHKIModal = memo(({ isOpen, onClose, entry }: ViewHKIModalProps) => {
  ...
  // 🐞 FIX: Berikan tipe 'Variants' pada objek animasi
      ...
      <DialogContent className="sm:max-w-3xl p-0 flex flex-col max-h-[90vh]">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 p-6">
            ...
            {/* Detail Keterangan & Sertifikat (full width) */}
            <motion.dl className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6" variants={itemVariants}>
