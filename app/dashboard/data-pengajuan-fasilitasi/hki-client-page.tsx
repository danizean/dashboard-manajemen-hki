...
export function HKIClientPage({ formOptions, error: serverError }: HKIClientPageProps) {
  ...
  const useHkiMutations = () => {
    ...
    const deleteMutation = useMutation({
      ...
      onSuccess: (data) => toast.success(data.message || 'Entri berhasil dihapus!'),
    ...
    const statusMutation = useMutation({
        ...
        onSuccess: (data) => toast.success(data.message || "Status berhasil diperbarui!"),
        onError: (err: Error, vars, context) => onMutationError(err, 'Gagal memperbarui status', context),
